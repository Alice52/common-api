 ...
 *
 * <ol>
 *   <li>get {@code project.name} from System Properties, if not null, use the value as app name;
 *   <li>get {@code sun.java.command} from System properties, remove path, arguments and ".jar" or
 *       ".JAR" suffix, use the result as app name. Note that whitespace in file name or path is not
 *       allowed, or a wrong app name may be gotten, For example:
 *       <p><code>
