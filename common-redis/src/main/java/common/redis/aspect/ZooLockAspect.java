...
import common.redis.annotation.LockKeyParam;
import common.redis.annotation.RedisLock;
import common.redis.annotation.ZooLock;
...
public class ZooLockAspect {
    ...
    public void doLock(ZooLock zooLock) {}
     ...
     */
    @SneakyThrows
    @Around("redisLockPointCut(zooLock)")
    public Object around(ProceedingJoinPoint point, ZooLock zooLock) throws Throwable {
